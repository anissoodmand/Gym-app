...
const packageEnrollment_routes_1 = __importDefault(require("./api/bodybuilding/routes/packageEnrollment.routes"));
...
app.use('/api/bodybuilding/enroll', packageEnrollment_routes_1.default);
